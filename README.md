...
ScriptMaker는 프레젠테이션 준비 과정에서 발생하는 **스크립트 작성 부담**을 획기적으로 줄이기 위해 설계된 웹 애플리케이션

기존 자동화 서비스들은 PPT를 단순 요약하는 수준에 머물러 발표자의 개별 의도나 맥락을 충분히 반영하지 못했다. ScriptMaker는 **사용자의 구어체 음성 발화**를 핵심 입력으로 삼아, 발표자가 강조하고 싶은 내용을 그대로 살린 스크립트를 생성. 나아가 생성된 스크립트를 **TTS + 립싱크 영상**으로까지 이어지는 파이프라인을 단일 인터페이스 안에서 제공.
...
<p align="center">
  <img src="images/system_interface.png" width="900">
</p>

<p align="center">
  <em>ScriptMaker interface for slide navigation, script generation, and multilingual translation.</em>
</p>
...
<p align="center">
  <img src="images/lipsync_video_example.png" width="600">
</p>

<p align="center">
  <em>Example of a lip-synced presentation video generated using OpenAI TTS and Wav2Lip.</em>
</p>
...
Microphone Recording                                   │
    │                                                  │
    ▼                                                  ▼
Whisper STT (Speech → Text) ───────────► Script Generation
                                                │
                                    ┌───────────┴───────────┐
                                    │  RAG Retrieval Layer  │
                                    │  (Vector Store)       │
                               ...
                               │                                 │
                               ▼                                 ▼
                         OpenAI TTS                      Multilingual Translation
                               │
                               ▼
                         Wav2Lip Lip Sync
                               │
